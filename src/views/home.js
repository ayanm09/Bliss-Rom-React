...
import NavElement from '../components/nav_element'
...
const Home = () => {
  return (
    <div className={styles['container']}>
      ...
      <nav className={` ${styles['navbar']} ${projectStyles['Navbar']} `}>
        <img
          alt="logo"
          src="/playground_assets/nav_logo.svg"
        ...
        <div className={styles['container1']}>
          <nav className={styles['Navelements']}>
            ...
            <a href="#features" className={styles['link']}>
              <NavElement
                Home="Features"
                className={` ${styles['component01']} ${projectStyles['thqLink']} `}
              ></NavElement>
            </a>
            <Link to="/team" className={styles['navlink1']}>
              <NavElement
                Home="Team"
                className={` ${styles['component02']} ${projectStyles['thqLink']} `}
              ></NavElement>
            </Link>
        ...
        <div className={styles['BtnGroup']}>
          <a href="#downloads" className={styles['link1']}>
            <Button
              rootClassName="rootClassName4"
              className={` ${styles['component05']} ${projectStyles['thqLink']} `}
            ></Button>
          </a>
        </div>
      ...
      <div className={styles['Hero']}>
        ...
        <span className={` ${styles['text01']} ${projectStyles['body-16']} `}>
        ...
        <img
          alt="image"
          src="/playground_assets/phone_img-1000w.png"
          className={styles['image1']}
        />
      </div>
      <div id="features" className={styles['Features-section']}>
        <div className={styles['featuresheader']}>
          <span className={` ${styles['text02']} ${projectStyles['h3-36']} `}>
      ...
      <div className={styles['Stats']}>
        <div className={styles['Stat']}>
          <svg viewBox="0 0 1152 1024" className={styles['icon13']}>
            ...
            <div className={styles['PC']}>
              ...
              >
                <Button
                  ...
                  className={` ${styles['component06']} ${projectStyles['thqLink']} `}
                ></Button>
              </a>
              <a
