        ...
        <div className={styles['LinksContainer']}>
          <div className={styles['Container1']}>
            <div className={styles['community-Container']}>
              <span className={styles['text06']}>Community</span>
              ...
              <span className={projectStyles['Footerlink']}>Bliss Discord</span>
            </div>
            <div className={styles['sources-Container']}>
              <span className={styles['text12']}>Sources</span>
              <span className={projectStyles['Footerlink']}>
              ...
              <span className={projectStyles['Footerlink']}>Contact</span>
            </div>
          </div>
          <div className={styles['container2']}>
            <div className={styles['Contact']}>
              <span
                className={` ${styles['text21']} ${projectStyles['footer-Text-Style']} `}
              >
                Links
              </span>
              <span className={projectStyles['Footerlink']}>Team members</span>
              <span className={projectStyles['Footerlink']}>Blog</span>
              <span className={projectStyles['Footerlink']}>Status</span>
            </div>
            <div className={styles['Socials']}>
              <span
                className={` ${styles['text25']} ${projectStyles['footer-Text-Style']} `}
              >
                Follow Us
              </span>
              <div className={styles['IconGroup']}>
                ...
                >
                  <svg
                    ...
                    className={` ${styles['icon']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
                ...
                >
                  <svg
                    ...
                    className={` ${styles['icon02']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
                ...
                >
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                    className={` ${styles['icon04']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
                ...
                >
                  <svg
                    ...
                    className={` ${styles['icon06']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
                ...
                >
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                    className={` ${styles['icon08']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
                ...
                >
                  <svg
                    viewBox="0 0 1024 1024"
                    className={` ${styles['icon10']} ${projectStyles['icons']} ${projectStyles['thqLink']} `}
                  >
